    ...
    <section class="post">
      <div class="row justify-content-md-center">
        <div class="col col-lg-12">
          ...
          <div class="post-body">
            <div class="post-card">
              <div class="post-card-title">贊助豆丁 ٩(^ᴗ^)۶</div>
              <div class="post-card-article border rounded p-2">
                ...
                <p>
                  👉<a href="mailto:q8156697@gmail.com">信箱</a> q8156697@gmail.com
                </p>
              </div>
            </div>
            <div class="post-card">
              <div class="post-card-title">實際行動 (๑´ㅂ`๑)</div>
              <div class="post-card-article border rounded p-2">
            ...
            <div class="post-card donate">
              <div class="post-card-title">贊助名單 由衷感謝你們 ٩(●˙▿˙●)۶…⋆ฺ</div>
              <div class="post-card-article border rounded p-2 ">
